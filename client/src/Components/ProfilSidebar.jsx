    ...
    <div className='max-h-screen h-screen overflow-y-hidden p-5'>
        ...
        <div className='mt-6'>
            <div className='flex flex-col items-center gap-1 justify-center'>
               {user.avatar ? 
                <img src={user.avatar} className='w-20 h-20 rounded-[50%] object-cover' alt="" />
                : <User size={80}/> }
            ...
            <div className='ml-1 mt-5'>
                ...
                <p>{user.bio? user.bio : <span className='opacity-50'>Pas de bio</span>}</p>
            </div>
        </div>
        <div className='ml-1 mt-6'>
            <ul className='flex flex-col gap-5'>
                <li className='flex gap-3'><Home/><Link to='/home/feed'> Feed</Link></li>
                <li className='flex gap-3'><Video/><Link to='/home/reel'> Reels</Link></li>
                <li className='flex gap-3'><Podcast/><Link to='/home/my-post'> My Posts</Link></li>
                <li className='flex gap-3'><Settings/><Link to='/home/setting'> Settings</Link></li>
                <li onClick={logOut} className='flex gap-3 mt-15 cursor-pointer'><LogOut/> Logout</li>
            </ul>
        </div>
    </div>
  )
